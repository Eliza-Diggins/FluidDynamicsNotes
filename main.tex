...
\include{Sections/ch4}
\chapter{Bernoulli's Theorem}
\include{Sections/ch9}
\chapter{Viscosity}
\input{Sections/ch10}
...
\include{Sections/ch5}
\chapter{Sound Waves}
\include{Sections/ch6}
\chapter{Supersonic Flows}
\include{Sections/ch7}
\chapter{Blastwaves}
\include{Sections/ch8.tex}
